...
pub fn hardsub_regions(key: &str) -> Vec<OcrRegionInput> {
    match key {
        "moon_sisters" => vec![
            OcrRegionInput { start: 1.6250005275973716, end: 6.498949253557576, x1: 0.2, y1: 0.38303571428571426, x2: 0.8, y2: 0.5830357142857143 },
            ...
            OcrRegionInput { start: 263.8815155779389, end: 270.4365261181527, x1: 0.20251116071428577, y1: 0.3875, x2: 0.8025111607142857, y2: 0.5875 },
        ],
        "glupov" => vec![
